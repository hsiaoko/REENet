...
int main(int argc, const char *argv[])
{
    ...
    mrlnet::MRLModule mrlmodule = mrlnet::REEModule("../models/embeding/dblp_acm_authors.bin", "../models/classifiers/rnn_linear_authors_seq.pt");
    ...
    for (int i = 0; i < csv_loader.tuples_->size(); i++)
    {
        ...
        float *rnn_embeding = mrlmodule.rnn_embeding(str_l, 64);
        for (int i = 0; i < 64; i++)
        {
            cout << rnn_embeding[i] << ", ";
        }
